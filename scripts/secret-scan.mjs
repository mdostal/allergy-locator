#!/usr/bin/env node
// Story s11 / hive.config.yaml's one hard quality gate: no key/token pattern
// may land in the repo or the built client bundle. Deliberately pattern-based
// (known key-format signatures), not a broad "contains the word key" check,
// which would false-positive on ordinary identifiers like allergen_id or
// backgroundColor throughout this codebase.
